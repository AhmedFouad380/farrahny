    ...
    init: function () {
        !(function () {
            ...
            if (t) {
                ...
                (a.width = a.height = e.size), t.appendChild(r), t.appendChild(a), o.translate(e.size / 2, e.size / 2), o.rotate((e.rotate / 180 - 0.5) * Math.PI);
                ...
                s("#E4E6EF", e.lineWidth, 1), s(KTUtil.getCssVariableValue("--bs-primary"), e.lineWidth, 100 / 150), s(KTUtil.getCssVariableValue("--bs-success"), e.lineWidth, 0.4);
            }
        })();
    },
};
    ...
    init: function () {
        !(function () {
            ...
            if (t) {
                ...
                s("#E4E6EF", e.lineWidth, 1), s(KTUtil.getCssVariableValue("--bs-danger"), e.lineWidth, 100 / 150), s(KTUtil.getCssVariableValue("--bs-primary"), e.lineWidth, 0.4);
            }
        })();
    },
};
...
var KTChartsWidget10 = (function () {
    ...
    return {
        init: function () {
            t("#kt_charts_widget_10_tab_1", "#kt_charts_widget_10_chart_1", [30, 18, 43, 70, 13, 37, 23], !0),
                t("#kt_charts_widget_10_tab_2", "#kt_charts_widget_10_chart_2", [25, 55, 35, 50, 45, 20, 31], !1),
                t("#kt_charts_widget_10_tab_3", "#kt_charts_widget_10_chart_3", [45, 15, 35, 70, 45, 50, 21], !1),
                t("#kt_charts_widget_10_tab_4", "#kt_charts_widget_10_chart_4", [15, 55, 25, 50, 25, 60, 31], !1);
        },
    };
})();
...
var KTChartsWidget11 = (function () {
    var t = function (t, e, a, r) {
        ...
        if (o) {
            ...
            !0 === r && (c.render(), (u = !0)),
                h.addEventListener("shown.bs.tab", function (t) {
                    0 == u && (c.render(), (u = !0));
                });
        }
    };
    return {
        init: function () {
            t("#kt_chart_widget_11_tab_1", "#kt_chart_widget_11_chart_1", [16, 19, 19, 16, 16, 14, 15, 15, 17, 17, 19, 19, 18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 20, 20, 22], !1),
                t("#kt_chart_widget_11_tab_2", "#kt_chart_widget_11_chart_2", [18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22, 15, 18, 18, 17, 17, 15, 15, 17, 17, 19, 17], !1),
                t("#kt_chart_widget_11_tab_3", "#kt_chart_widget_11_chart_3", [17, 20, 20, 19, 19, 17, 17, 19, 19, 21, 21, 19, 19, 21, 21, 18, 18, 16, 17, 17, 19, 19, 21, 21, 19, 19, 17, 17, 18, 18], !0);
        },
    };
})();
...
var KTChartsWidget12 = (function () {
    ...
    return {
        init: function () {
            t("#kt_charts_widget_12_tab_1", "#kt_charts_widget_12_chart_1", [54, 42, 75, 110, 23, 87, 50], !0),
                t("#kt_charts_widget_12_tab_2", "#kt_charts_widget_12_chart_2", [25, 55, 35, 50, 45, 20, 31], !1),
                t("#kt_charts_widget_12_tab_3", "#kt_charts_widget_12_chart_3", [45, 15, 35, 70, 45, 50, 21], !1),
                (function () {
...
var KTChartsWidget2 = {
    init: function () {
        var t;
        (t = document.querySelectorAll(".charts-widget-2")),
                    ...
                    r = new ApexCharts(t, {
                        ...
                        yaxis: {
                            labels: {
                                ...
                                style: { colors: e, fontSize: "14px", fontWeight: "600" },
                                offsetY: 2,
                                align: "left",
                            },
                        },
    ...
    var t = function (t) {
        ...
        if (e) {
            ...
            !0 === initByDefault && (i.render(), (s = !0)),
                n.addEventListener("shown.bs.tab", function (t) {
                    0 == s && (i.render(), (s = !0));
                }),
...
var KTChartsWidget8 = (function () {
    ...
    return {
        init: function () {
            t("#kt_chart_widget_8_week_toggle", "#kt_chart_widget_8_week_chart", [[[100, 250, 30]], [[225, 300, 35]], [[300, 350, 25]], [[350, 350, 20]], [[450, 400, 25]], [[550, 350, 35]]], !1),
                t("#kt_chart_widget_8_month_toggle", "#kt_chart_widget_8_month_chart", [[[125, 300, 40]], [[250, 350, 35]], [[350, 450, 30]], [[450, 250, 25]], [[500, 500, 30]], [[650, 250, 28]]], !0);
        },
    };
})();
            ...
            t.addEventListener("shown.bs.tab", (e) => {
                ...
                (() => {
                    ...
                    var e = Date.now(),
                        ...
                        o = new vis.DataSet([
                            { id: 1, group: 1, start: e, end: moment(e).add(7, "days"), content: "Framework", progress: "71%", color: "primary", users: ["avatars/150-1.jpg", "avatars/150-2.jpg"] },
                            { id: 2, group: 2, start: moment(e).add(7, "days"), end: moment(e).add(14, "days"), content: "Accessibility", progress: "84%", color: "success", users: ["avatars/150-3.jpg"] },
                            { id: 3, group: 3, start: moment(e).add(3, "days"), end: moment(e).add(20, "days"), content: "Microsites", progress: "69%", color: "danger", users: ["avatars/150-4.jpg", "avatars/150-5.jpg"] },
                            {
                                id: 4,
                                group: 4,
                ...
                (() => {
                    ...
                    var e = Date.now(),
                        ...
                        o = new vis.DataSet([
                            { id: 1, group: "research", start: e, end: moment(e).add(2, "months"), content: "Tags", progress: "79%", color: "primary", users: ["avatars/150-1.jpg", "avatars/150-2.jpg"] },
                            { id: 2, group: "qa", start: moment(e).add(0.5, "months"), end: moment(e).add(5, "months"), content: "Testing", progress: "64%", color: "success", users: ["avatars/150-3.jpg"] },
                            { id: 3, group: "ui", start: moment(e).add(2, "months"), end: moment(e).add(6.5, "months"), content: "Media", progress: "82%", color: "danger", users: ["avatars/150-4.jpg", "avatars/150-5.jpg"] },
                            {
                                id: 4,
                                group: "dev",
        ...
        init: function () {
            (() => {
                ...
                var e = Date.now(),
                    ...
                    o = new vis.DataSet([
                        { id: 1, group: "research", start: e, end: moment(e).add(1.5, "hours"), content: "Meeting", progress: "60%", color: "primary", users: ["avatars/150-1.jpg", "avatars/150-2.jpg"] },
                        { id: 2, group: "qa", start: moment(e).add(1, "hours"), end: moment(e).add(2, "hours"), content: "Testing", progress: "47%", color: "success", users: ["avatars/150-3.jpg"] },
                        { id: 3, group: "ui", start: moment(e).add(30, "minutes"), end: moment(e).add(2.5, "hours"), content: "Landing page", progress: "55%", color: "danger", users: ["avatars/150-4.jpg", "avatars/150-5.jpg"] },
                        {
                            id: 4,
                            group: "dev",
...
var KTTablesWidget3 = (function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_widget_table_3")) &&
            ((e = $(t).DataTable({ info: !1, order: [], paging: !1, pageLength: !1 })),
                (() => {
                    ...
                    t.forEach((r) => {
                        r.addEventListener("click", (o) => {
                            ...
                            t.forEach((t) => {
                                ...
                                r.classList.add(...a),
                                "Show All" === i ? e.search("").draw() : e.search(i).draw();
                        });
                    });
                })(),
                a());
    ...
    const r = () => {
        ...
        s = (e, r) => {
            e.forEach((o, i) => {
                ...
                n.setAttribute("src", g + o.image + ".gif"),
                    (l.innerText = o.name),
                    (d.innerText = o.description),
                    (c.innerText = o.cost),
                    (u.innerText = o.qty),
                    (h.innerText = o.total),
                    o.stock > 10 ? (p.innerHTML = '<div class="badge badge-light-success">In Stock</div>') : (p.innerHTML = '<div class="badge badge-light-warning">Low Stock</div>'),
                1 === e.length || e.length;
...
var KTTablesWidget5 = (function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_table_widget_5_table")) &&
            (t.querySelectorAll("tbody tr").forEach((t) => {
                const e = t.querySelectorAll("td"),
                    a = moment(e[2].innerHTML, "MMM DD, YYYY").format();
                e[2].setAttribute("data-order", a);
            }),
                (e = $(t).DataTable({ info: !1, order: [], lengthChange: !1, pageLength: 6, paging: !1, columnDefs: [{ orderable: !1, targets: 1 }] })),
                a());
        },
    };
})();
