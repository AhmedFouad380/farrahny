    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">{{__('lang.Orders')}} </h1>
                <!--end::Heading-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{__('lang.Orders')}}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title=-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.order-status')}} </th>
                            <th class="min-w-125px">{{__('lang.payment-type')}} </th>
                            <th class="min-w-125px">{{__('lang.total')}}  </th>
                            <th class="min-w-125px"> {{__('lang.order-details')}}  </th>
                        </tr>
                        <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
