            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="" enctype="multipart/form-data" class="form" method="post"
                          action="{{url('store-provider_subscriptions')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="provider_id" id="provider_id" class="form-control select2" required>
                                    <option>{{__('lang.choose_provider')}}</option>
                                    @foreach(\App\Models\Provider::active()->get()  as $row)
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('lang.subscription')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select name="subscription_id" id="subscription_id" class="form-control select2"
                                        required>
                                    <option>{{__('lang.choose_subscription')}}</option>
        ...
        if (dataList.length > 0) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{url("delete-provider_subscriptions")}}',
                        type: "get",
