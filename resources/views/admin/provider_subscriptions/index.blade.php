...
@section('title',__('lang.provider_subscriptions'))
@section('css')
    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div
                ...
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">{{__('lang.provider_subscriptions')}} </h1>
                <!--end::Heading-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{__('lang.provider_subscriptions')}}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title=-->
...
{{--                            </th>--}}
                            ...
                            <th class="min-w-125px">{{__('lang.subscription')}}</th>
                            <th class="min-w-125px">{{__('lang.from_date')}}</th>
                            <th class="min-w-125px">{{__('lang.to_date')}}</th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('provider_subscriptions.datatable.data') }}',
                    data: {}
                },
                columns: [
                    // {data: 'checkbox', name: 'checkbox', "searchable": false, "orderable": false},
                    {data: 'provider', name: 'name_ar', "searchable": true, "orderable": true},
                    {data: 'subscription', name: 'name_en', "searchable": true, "orderable": true},
                    {data: 'from_date', name: 'from_date', "searchable": true, "orderable": true},
                    {data: 'to_date', name: 'to_date', "searchable": true, "orderable": true},
                    {data: 'status_btn', name: 'status_btn', "searchable": true, "orderable": true},
                ]
            });
            $.ajax({
                url: "{{ URL::to('/add-button-provider_subscriptions')}}",
