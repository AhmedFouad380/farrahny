                                            ...
                                            <div
                                                ...
                                                <div class="mb-7 text-center">
                                                    ...
                                                    <div class="text-center">
                                                        <span class="mb-2 text-primary">{{trans('lang.currency')}}</span>
                                                ...
                                                <div class="w-100 mb-10">
                                                    ...
                                                    <div class="d-flex align-items-center mb-5">
                                                        <span class="fw-bold fs-6 text-gray-800 flex-grow-1 pe-3">{{trans('lang.days_count')}} {{$row->days_count}}</span>
                                                    ...
                                                    <!--begin::Item-->
                                                    <div class="d-flex align-items-center mb-5">
                                                        <span class="fw-bold fs-6 text-gray-800 flex-grow-1 pe-3">{{trans('lang.service_count')}} {{$row->service_count}}</span>
                                                        <!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
                                                        <span class="svg-icon svg-icon-1 svg-icon-success">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                         height="24" viewBox="0 0 24 24" fill="none">
                                                    ...
                                                    <!--begin::Item-->
                                                    <div class="d-flex align-items-center mb-5">
                                                        <span class="fw-bold fs-6 text-gray-800 flex-grow-1 pe-3">{{trans('lang.service_image_count')}} {{$row->service_image_count}}</span>
                                                        <!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
                                                        <span class="svg-icon svg-icon-1 svg-icon-success">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                         height="24" viewBox="0 0 24 24" fill="none">
                                                    ...
                                                    <!--begin::Item-->
                                                    <div class="d-flex align-items-center mb-5">
                                                        <span class="fw-bold fs-6 text-gray-800 flex-grow-1 pe-3">{{trans('lang.is_video')}}</span>
                                                        <!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
                                                       @if($row->is_video)
                                                        <span class="svg-icon svg-icon-1 svg-icon-success">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <!--end::Features-->
                                                <!--begin::Select-->
                                                <a href="#" class="btn btn-sm btn-primary">{{trans('lang.subscribe')}}</a>
                                                <!--end::Select-->
                                            </div>
                                            <!--end::Option-->
                                        </div>
