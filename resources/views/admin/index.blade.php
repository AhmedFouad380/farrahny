        ...
        <div class="content flex-row-fluid" id="kt_content">
            <!--begin::Card-->
                ...
                <div class="row g-5 g-xl-8">
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="{{url('Orders')}}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{$count['orders']}}</div>
                                <div class="fw-bold text-gray-100">{{__('lang.Orders')}}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="{{url('Events_setting')}}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$count['events']}}</div>
                                <div class="fw-bold text-white">{{__('lang.Events')}}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-3">
                        <!--begin::Statistics Widget 5-->
                        <a href="{{url('Categories_setting')}}" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                            <!--begin::Body-->
                            <div class="card-body">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-xl-stretch mb-xl-10" style="background-color: #F7D9E3">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                <!--begin::Title-->
                                <a  class="text-dark text-hover-primary fw-bolder fs-3">{{__('lang.Providers')}}</a>
                                <!--end::Title-->
                                <!--begin::Chart-->
                                <!--end::Chart-->
                            </div>
                            ...
                            <div class="pt-5">
                                ...
                                <!--end::Symbol-->
                                <!--begin::Number-->
                                <span class="text-dark fw-bolder fs-3x me-2 lh-0">{{$count['providers']}}</span>
                                <!--end::Number-->
                                <!--begin::Text-->
                    ...
                    <div class="card card-xxl-stretch mb-xl-10" style="background-color: #CBF0F4">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                <!--begin::Title-->
                                <a class="text-dark text-hover-primary fw-bolder fs-3">{{__('lang.Users')}}</a>
                                <!--end::Title-->
                                <!--begin::Chart-->
                                <!--end::Chart-->
                            </div>
                            ...
                            <div class="pt-5">
                                <!--begin::Number-->
                                <span class="text-dark fw-bolder fs-3x me-2 lh-0">{{\App\Models\User::count()}}</span>
                                <!--end::Number-->
                                <!--begin::Text-->
                                <!--end::Text-->
                            </div>
                    ...
                    <div class="card card-xl-stretch-50 mb-5 mb-xl-8">
                        ...
                        <div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-9 pb-3">
                                <div class="me-2">
                                    <span class="fw-bolder text-gray-800 d-block fs-3">{{__('lang.RegisterCount')}}</span>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-xl-stretch mb-xl-10" style="background-color: #F7D9E3">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                <!--begin::Title-->
                                <a  class="text-dark text-hover-primary fw-bolder fs-3">{{__('lang.incomeYear')}}</a>
                                <!--end::Title-->
                                <!--begin::Chart-->
                                <!--end::Chart-->
                            </div>
                            ...
                            <div class="pt-5">
                                ...
                                <!--end::Symbol-->
                                <!--begin::Number-->
                                <span class="text-dark fw-bolder fs-3x me-2 lh-0">
                                                                    {{\App\Models\ProviderSubscription::whereYear('created_at',date('Y'))->sum('price')}}
                    ...
                    <div class="card card-xxl-stretch mb-xl-10" style="background-color: #CBF0F4">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                <!--begin::Title-->
                                <a class="text-dark text-hover-primary fw-bolder fs-3">{{__('lang.incomeMonth')}}</a>
                                <!--end::Title-->
                                <!--begin::Chart-->
                                <!--end::Chart-->
                            </div>
                            ...
                            <div class="pt-5">
                                <!--begin::Number-->
                                <span class="text-dark fw-bolder fs-3x me-2 lh-0">
                                 {{\App\Models\ProviderSubscription::whereYear('created_at',date('Y'))->whereMonth('created_at',date('m'))->sum('price')}}
                                </span>
                                <!--end::Number-->
                                <!--begin::Text-->
                                <!--end::Text-->
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            ...
                            <div class="flex-grow-1 card-p pb-0">
                                <div class="d-flex flex-stack flex-wrap">
                                    <div class="me-2">
                                        <a href="#" class="text-dark text-hover-primary fw-bolder fs-3">{{trans('lang.income_by_sign_up_providers')}}</a>
                                        <div class="text-muted fs-7 fw-bold"></div>
                                    </div>
                                    <div class="fw-bolder fs-3 text-primary">{{\App\Models\ProviderSubscription::whereYear('created_at',date('Y'))->sum('price')}}</div>
                                </div>
                            </div>
                            <!--end::Stats-->
                            <!--begin::Chart-->
        ...
        (function () {
            ...
            [].slice.call(o).map(function (o) {
                (e = o.getAttribute("data-kt-color")),
                    ...
                    new ApexCharts(o, {
                        series: [
                            { name: "{{__('lang.Providers')}}", data:
                                    [
                                        @for($x = 1; $x <= 12; $x++)
                                        {{\App\Models\Provider::whereYear('created_at',date('Y'))->whereMonth('created_at',$x)->count()}},
                                        @endfor
                                    ]
                            },
                            { name: "{{__('lang.Users')}}", data: [
                                    @for($x = 1; $x <= 12; $x++)
