                                    ...
                                    <div
                                        ...
                                        <div id="kt_aside_menu_wrapper" class="menu-fit">
                                            ...
                                            @elseif(Auth::guard('admin')->check())
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'Pages_setting') active @endif" href="{{url('Pages_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'ClientImages_setting') active @endif" href="{{url('ClientImages_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
