...
<head>
    <base href="../">
    <title>  {{App\Models\Setting::findOrfail(1)->name }} || @yield('title')
    </title>
    <meta charset="utf-8"/>
                ...
                <div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <a @if(Session('lang') == 'en') href="{{url('lang/ar')}}" @else href="{{url('lang/en')}}"
                           ...
                           title="{{__('lang.language')}}" id="kt_activities_toggle">
                                    ...
                                    <div
                                        ...
                                        <div id="kt_aside_menu_wrapper" class="menu-fit">
                                            @if(Auth::guard('provider')->check())
                                                <div class="menu-item">
                                                    <div class="menu-content pb-2">
                                                        <span
                                                            class="menu-section text-muted text-uppercase fs-8 ls-1">{{__('lang.Dashboard')}}</span>
                                                    </div>
                                                </div>

                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{url('/ProviderDashboard')}}">
                                                ...
                                                <div class="menu-item">
                                                    <div class="menu-content pt-8 pb-2">
                                                        <span
                                                            class="menu-section text-muted text-uppercase fs-8 ls-1">{{trans('lang.pages')}}</span>
                                                    </div>
                                                </div>
                                                <div class="menu-item">
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{url('subscribtion')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            ...
                                            @elseif(Auth::guard('admin')->check())
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'Admin_setting') active @endif " href="{{url('/Admin_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'User_setting') active @endif" href="{{url('/User_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'Providers_setting') active @endif" href="{{url('/Providers_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'cities') active @endif" href="{{url('/cities_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'Slider_setting') active @endif" href="{{url('/Slider_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'OfferSlider_setting') active @endif" href="{{url('/OfferSlider_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        ...
                                                        <span class="menu-title">{{__('lang.OfferSlider')}}</span>
                                                    </a>
                                                </div>

                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'Events_setting') active @endif" href="{{url('Events_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'Categories_setting') active @endif" href="{{url('Categories_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'subscriptions') active @endif" href="{{route('subscriptions')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        ...
                                                        <span class="menu-title">{{__('lang.subscriptions')}}</span>
                                                    </a>
                                                </div>
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'Services_setting') active @endif" href="{{url('Services_setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{url('Pages_setting')}}">
                                                    <span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'Contact_Setting') active @endif" href="{{url('Contact_Setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link @if(request()->segment(1) == 'General_Setting') active @endif" href="{{url('General_Setting')}}">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
