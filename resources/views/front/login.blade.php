                           ...
                           <form action="{{url('Login')}}" method="post">
                               @csrf
                                    <div class="d-flex position-relative">
                                        ...
                                        <input type="email" placeholder="{{__('lang.Enter your email')}}" name="email" class="form-control mb-3 p-3 login-form">
                                    </div>
                                    <div class="d-flex position-relative">
                                        <span class="span-form2"></span>
                                        <input type="password" placeholder="{{__('lang.Enter your password')}}" name="password" class="form-control mb-3 p-3 login-form2">
                                    </div>
                                    <div class="d-sm-block d-md-flex justify-content-between">
                                        ...
                                        <a href="#" class="text-capitalize form-login-color">{{__('lang.forget password ?')}}</a>
                                    </div>
                                    <button  type="submit" class="btn login-btn my-3 text-uppercase me-1">{{__('lang.login')}}</button>
                                    <a class="btn sign-btn my-3 text-uppercase me-1" href="{{url('register')}}">{{__('lang.Register')}}</a>
